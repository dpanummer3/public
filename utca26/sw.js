const SHELL_CACHE='utca-shell-v77';
const PHOTO_CACHE='utca-place-photo-v1';
const APP_SHELL=['/','/app.css?v=122','/app.js?v=120','/manifest.webmanifest?v=97','/onboarding-checkin.webp?v=97','/onboarding-options.webp?v=97'];
