const SHELL_CACHE='utca-shell-v96';
const PHOTO_CACHE='utca-place-photo-v1';
const APP_SHELL=['/','/app.css?v=128','/app.js?v=134','/manifest.webmanifest?v=97','/onboarding-checkin.webp?v=97','/onboarding-options.webp?v=97'];
